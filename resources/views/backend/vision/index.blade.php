    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header row">
                <div class="col-sm-2">
                    <a href="{{ route('vision.create') }}" class="btn btn-sm btn-primary">{{ __('Add Vision Detail') }}</a>
                </div>
            </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('vision.edit',encrypt($detail->id)) }}" class="btn btn-sm btn-primary">{{ __('Edit') }}</a>
                                    <a href="{{ route('vision.delete',encrypt($detail->id)) }}" class="btn btn-sm btn-danger">{{ __('Delete') }}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
