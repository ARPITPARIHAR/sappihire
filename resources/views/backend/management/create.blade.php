...
@section('name')
    ...
    <li class="breadcrumb-item"><a href="#!">{{ __('Add Management') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
            ...
            <div class="card-block">
                <form action="{{ route('management.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sub_designation" id="subdesignation" value="{{ old('sub_designation')}}" placeholder="{{ __('Enter Sub Designation') }}" class="form-control @error('designation') form-control-danger @enderror">
                            @error('designation')
                                <p class="text-danger error">{{ $message }}</p>
                            @else
                                <p class="text-muted">{{ __('') }}</p>
