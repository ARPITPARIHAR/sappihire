...
@section('meta_title', __(' Edit Hostel Facility'))

@section('page_name', __(' Edit Hostel Facility'))

@section('page_description', __(' Edit Hostel Facility'))

@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __(' Edit Hostel Facility') }}</a></li>
@endsection
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('hostelfacility.update', encrypt($hostels->id)) }}" method="POST">
                    @csrf
