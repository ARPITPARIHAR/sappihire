...
@section('meta_title', __('Team Index'))

@section('page_name', __('Team Index'))
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- <a href="{{ route('table.edit', $record->id) }}" class="btn btn-warning btn-sm">Edit</a> --}}
                             <form action="{{ route('team.destroy', $record->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
