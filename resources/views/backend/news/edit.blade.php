...
@section('meta_title',__('Client  News'))

@section('page_name',__('Client  News'))

@section('page_description',__('Client  News'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Client  News') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('news.update',encrypt($news->id)) }}" method="POST" >
                    @csrf
                    {{-- <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="news_description" id="news_description" placeholder="{{ __('Enter News Description') }}" class="form-control @error('news_description') form-control-danger @enderror">{{ old('news_description') ?? $news->news_description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="url" name="hyperlink" id="hyperlink" value="{{ old('hyperlink') ?? $news->hyperlink }}" placeholder="{{ __('Enter Hyperlink') }}" class="form-control @error('hyperlink') form-control-danger @enderror">
                            @error('hyperlink')
                                <p class="text-danger error">{{ $message }}</p>
                            @else
                                <p class="text-muted">{{ __('') }}</p>
