...
@section('meta_title',__('Edit Reliving Orders'))

@section('page_name',__('Edit Reliving Orders'))

@section('page_description',__('Edit Reliving Orders'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Edit Reliving Orders') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('relieve.update',encrypt($detail->id)) }}" method="POST" >
                    @csrf
