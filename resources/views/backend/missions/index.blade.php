    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header row">
                <div class="col-sm-2">
                    <a href="{{ route('missions.create') }}" class="btn btn-sm btn-primary">{{ __('Add Mission Detail') }}</a>
                </div>
            </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('missions.edit',encrypt($detail->id)) }}" class="btn btn-sm btn-primary">{{ __('Edit') }}</a>
                                    <a href="{{ route('missions.delete',encrypt($detail->id)) }}" class="btn btn-sm btn-danger">{{ __('Delete') }}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
