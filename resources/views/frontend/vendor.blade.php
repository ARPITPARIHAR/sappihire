...
<section class="cntct_buyer vndr">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="buyer">
					<p>Vendor - If you are anyways connected to apparel/home furnishing industry supplier, manufacturer Raw material , accessories , printing ,embroidery etc and you are passionate about your product. We are waiting for you, contact us. <a href="#">Email:-purchase@sapphirefashions.in</a></p>
                    @if(session('success'))
                ...
                <form action="{{ route('vendor.submit') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="chs_fil">
										<input class="form-control" type="file" id="actual-btn" name="thumbnail_img" hidden/>
